...
(function (global, factory) {
  ...
  function addListener(element, type, listener) {
    ...
    type.trim().split(REGEXP_SPACES).forEach(function (event) {
      ...
      element.addEventListener(event, _handler, {passive: true});
    });
  }
  /**
  ...
  var handlers = {
    ...
    wheel: function wheel(event) {
      ...
      //event.preventDefault(); //Disabled because when enabled, makes errors in the console because of {passive:true} L543 instead of options
