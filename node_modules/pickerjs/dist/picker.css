...
.picker {
  ...
  direction: ltr;
  display: none;
  font-size: calc(var(--size-multiplier)*1rem);
  /*line-height: calc((var(--size-multiplier) - 0.5)*1.5);*/
  overflow: hidden;
...
.picker-header {
  ...
  display: none;
  padding: calc(var(--size-multiplier)*0.875rem) calc(var(--size-multiplier)*1.25rem);
  position: relative;
}

.picker-title {
  font-size: calc(var(--size-multiplier)*1.125rem);
  font-weight: 500;
  line-height: calc(var(--size-multiplier)*1.25rem);
  margin: 0;
}
...
.picker-close {
  ...
  color: var(--gray);
  cursor: pointer;
  font-size: calc(var(--size-multiplier)*1.75rem);
  height: calc(var(--size-multiplier)*3rem);
  opacity: 0.75;
  padding: 0;
  position: absolute;
  right: calc(var(--size-multiplier)*1.25rem);
  top: 0;
  width: 3rem;
}
...
.picker-cell__header {
  color: #999;
  color: var(--gray);
  font-size: calc(var(--size-multiplier)*0.875rem);
  font-weight: 500;
  line-height: calc(var(--size-multiplier)*1.5rem);
  margin: 0;
  overflow: hidden;
  padding: calc(var(--size-multiplier)*0.25rem) calc(var(--size-multiplier)*0.5rem);
  text-align: center;
...
.picker-item {
  color: #999;
  color: var(--gray);
  padding: calc(var(--size-multiplier)*3*0.25rem) calc(var(--size-multiplier)*0.5rem);
  /*line-height: calc((var(--size-multiplier) * 0.75)*1.5);*/
  text-align: center;
  white-space: nowrap;
}
...
.picker-picked {
  ...
  font-size: calc((var(--size-multiplier) * 0.75) * 1.125em);
  line-height: calc(var(--size-multiplier) * 0.75 * 1.5rem);
}
...
.picker-confirm {
  ...
  display: table-cell;
  font-size: calc(var(--size-multiplier)*1rem);
  padding: calc(var(--size-multiplier)*0.75rem) calc(var(--size-multiplier)*1rem);
  width: 50%;
}
